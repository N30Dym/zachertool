...
class ZachernProtokolleBeladung extends Seeder
{
    ...
    public function run()
    {
        $query = "INSERT IGNORE INTO `beladung` (`protokollSpeicherID`, `flugzeugHebelarmID`, `bezeichnung`, `hebelarm`, `gewicht`) VALUES
            ...
            (47, 38, NULL, NULL, 74),
            (47, 39, NULL, NULL, 90),
            (48, 38, 'Fallschirm', NULL, 6),
            (48, 39, 'Fallschirm', NULL, 6),
            (48, 38, NULL, NULL, 74),
            (48, 39, NULL, NULL, 90),
            (49, 15, 'Fallschirm', NULL, 7),
            (49, 15, NULL, NULL, 68),
            ...
            (58, 41, NULL, NULL, 0),
            (59, NULL, 'Fallschirm', NULL, 6),
            (59, NULL, 'Fallschirm', NULL, 6),
            (59, NULL, NULL, NULL, 73),
            (59, NULL, NULL, NULL, 67),
            (60, 44, NULL, NULL, 7.5),
            (60, 43, NULL, NULL, 71),
            (61, 41, 'Fallschirm', NULL, 7),
            (61, 41, NULL, NULL, 95),
            (62, NULL, 'Fallschirm', NULL, 6),
            (62, NULL, 'Fallschirm', NULL, 6),
            (62, NULL, NULL, NULL, 73),
            (62, NULL, NULL, NULL, 95),
