...
class ZachernProtokolleKommentare extends Seeder
{
    ...
    public function run()
    {
        $query = "INSERT IGNORE INTO `kommentare` (`protokollSpeicherID`, `protokollKapitelID`, `kommentar`) VALUES
            ...
            (13, 10, 'offenbar falsch, da keines der Ruder bei 100%'),
            (13, 12, 'Ver- und Entriegelungskraft geschätzt'),
            (13, 19, 'abgebrochen'),
            (13, 20, '17.1: unplausible Werte'),
            (14, 19, 'Höhenruder fest'),
            (15, 5, 'Bei Linkskurven musste etwas gestützt werden'),
