...
class ZachernprotokolllayoutProtokollInputs extends Seeder
{
    ...
    public function run()
    {
        $query = "INSERT IGNORE INTO `protokoll_inputs` (`id`, `inputID`, `bezeichnung`, `aktiv`, `einheit`, `hStWeg`, `bereichVon`, `bereichBis`, `groesse`, `schrittweite`, `multipel`, `benoetigt`) VALUES
            ...
            (76, 3, NULL, 1, 'km/h', NULL, 0.00, NULL, NULL, NULL, NULL, NULL),
            (77, 3, NULL, 1, 'mm', 1, 0.00, NULL, NULL, NULL, NULL, NULL),
            (78, 3, NULL, 1, 'km/h', NULL, 0.00, NULL, NULL, NULL, NULL, NULL),
            (79, 4, NULL, 1, 'daN', NULL, NULL, NULL, NULL, 0.01, NULL, NULL),
