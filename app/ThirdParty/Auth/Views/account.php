...
<form method="POST" action="<?= base_url('account'); ?>" accept-charset="UTF-8">
	<?= csrf_field() ?>
	<p>
...
<form method="POST" action="<?= base_url('change-email'); ?>" accept-charset="UTF-8"
...
<form method="POST" action="<?= base_url('change-password'); ?>" accept-charset="UTF-8"
...
<form method="POST" action="<?= base_url('delete-account') ?>" accept-charset="UTF-8">
    <?= csrf_field() ?>
