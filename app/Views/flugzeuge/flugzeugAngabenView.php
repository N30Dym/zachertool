            ...
            <div class="row g-3">
                <div class="col-sm-7">
                    ...
                    <input type="text" class="form-control" name="flugzeug[musterSchreibweise]" id="musterSchreibweise" placeholder="DG-1000, ASK 21, Discus 2, ..." value="<?= esc($flugzeug['musterSchreibweise']) ?? "" ?>" required <?= isset($musterID) ? "readonly" : "" ?>>
                </div>
