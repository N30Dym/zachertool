        ...
        <form action="/zachern-dev/piloten/speichern" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" name="pilot[spitzname]" value="<?= isset($pilotArray['spitzname']) ? esc($pilotArray['spitzname']) : (isset($spitzname) ? esc($spitzname) : "") ?>" required <?= isset($pilotID) ? "readonly" : "" ?>>
                </div>
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="pilot[groesse]" value="<?= isset($pilotArray['groesse']) ? esc($pilotArray['groesse']) : (isset($groesse) ? esc($groesse) : "") ?>" required <?= isset($pilotID) ? "readonly" : "" ?>>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <?php if(isset($pilotID)) : ?>
                        <?php foreach($pilotDetailsArray as $pilotDetail) : ?>
                            ...
                            <td><input type="number" class="form-control" name="pilotDetail[stundenNachSchein]" min="0" value="<?= $pilotDetail['stundenNachSchein'] ?>" disabled></td>
                            <td><input type="number" class="form-control" name="pilotDetail[geflogeneKm]" min="0" value="<?= $pilotDetail['geflogeneKm'] ?>" disabled></td>
                            <td><input type="number" class="form-control" name="pilotDetail[typenAnzahl]" min="0" value="<?= $pilotDetail['typenAnzahl'] ?>" disabled></td>
                            <td><input type="number" class="form-control" name="pilotDetail[gewicht]" min="0" value="<?= $pilotDetail['gewicht'] ?>" disabled></td>
                        </tr>
                        <?php endforeach ?>
                    <?php endif ?>
                        <tfoot>
                            <tr>
                                ...
                                <td><input type="number" class="form-control" name="pilotDetail[stundenNachSchein]" min="0" value="<?= isset($stundenNachSchein) ? esc($stundenNachSchein) : "" ?>" required></td>
                                <td><input type="number" class="form-control" name="pilotDetail[geflogeneKm]" min="0" value="<?= isset($geflogeneKm) ? esc($geflogeneKm) : "" ?>" required></td>
                                ...
                                <td><input type="number" class="form-control" name="pilotDetail[gewicht]" min="0" value="<?= isset($gewicht) ? esc($gewicht) : "" ?>" required></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
