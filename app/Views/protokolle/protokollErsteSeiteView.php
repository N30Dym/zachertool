    ...
    <div class="col-lg-10 mt-3 border rounded shadow p-4">
        ...
        <div class="row g-3">
            <div class="col-sm-7 ">
                ...
                <input type="date" class="form-control datepicker" name="protokollInformation[datum]" max="<?= date('Y-m-d') ?>" placeholder="TT.MM.JJJJ" value="<?= isset($_SESSION["protokollInformationen"]["datum"]) ? $_SESSION["protokollInformationen"]["datum"] : "" ?>" required>
            </div>
            ...
            <div class="col-12">
                ...
                <input name="protokollInformation[bemerkung]" type="text" class="form-control" id="bemerkung" placeholder="Allgemeines zu deinem Protokoll" value="<?= isset($_SESSION["protokollInformationen"]["bemerkung"]) ? $_SESSION["protokollInformationen"]["bemerkung"] : "" ?>" >
            </div>
