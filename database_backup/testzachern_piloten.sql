...
--
-- Datenbank: `testzachern_piloten`
--
CREATE DATABASE IF NOT EXISTS `testzachern_piloten` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `testzachern_piloten`;
